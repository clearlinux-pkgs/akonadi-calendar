...
Version  : 24.12.3
Release  : 87
URL      : https://download.kde.org/stable/release-service/24.12.3/src/akonadi-calendar-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/akonadi-calendar-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/akonadi-calendar-24.12.3.tar.xz.sig
...
%setup -q -n akonadi-calendar-24.12.3
cd %{_builddir}/akonadi-calendar-24.12.3
pushd ..
cp -a akonadi-calendar-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742534272
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6AkonadiCalendar.so.6.3.3
...
/usr/lib64/libKPim6AkonadiCalendar.so.6.3.3
