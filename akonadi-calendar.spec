...
Source0  : https://download.kde.org/stable/release-service/19.12.1/src/akonadi-calendar-19.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.1/src/akonadi-calendar-19.12.1.tar.xz.sig
...
%prep
%setup -q -n akonadi-calendar-19.12.1
cd %{_builddir}/akonadi-calendar-19.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578931461
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/akonadi-calendar-19.12.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/akonadi-calendar/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5AkonadiCalendar.so.5.13.1
