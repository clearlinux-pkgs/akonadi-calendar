...
Version  : 22.04.3
Release  : 46
URL      : https://download.kde.org/stable/release-service/22.04.3/src/akonadi-calendar-22.04.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.04.3/src/akonadi-calendar-22.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.3/src/akonadi-calendar-22.04.3.tar.xz.sig
...
%prep
%setup -q -n akonadi-calendar-22.04.3
cd %{_builddir}/akonadi-calendar-22.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657642747
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/akonadi-calendar-22.04.3/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/akonadi-calendar/c085897bc39e05746ffd2d889a6e84ff1b7ae2d9
cp %{_builddir}/akonadi-calendar-22.04.3/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/akonadi-calendar/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/akonadi-calendar-22.04.3/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/akonadi-calendar/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/akonadi-calendar-22.04.3/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/akonadi-calendar/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/akonadi-calendar-22.04.3/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/akonadi-calendar/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/akonadi-calendar-22.04.3/README.md.license %{buildroot}/usr/share/package-licenses/akonadi-calendar/cadc9e08cb956c041f87922de84b9206d9bbffb2
cp %{_builddir}/akonadi-calendar-22.04.3/metainfo.yaml.license %{buildroot}/usr/share/package-licenses/akonadi-calendar/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
cp %{_builddir}/akonadi-calendar-22.04.3/reminder-daemon/kalendarac.notifyrc.license %{buildroot}/usr/share/package-licenses/akonadi-calendar/e9aa865961a8cfb32e5c081920b28aa634edef10
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5AkonadiCalendar.so.5.20.3
