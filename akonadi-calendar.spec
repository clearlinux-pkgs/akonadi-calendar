...
Version  : 24.05.2
Release  : 76
URL      : https://download.kde.org/stable/release-service/24.05.2/src/akonadi-calendar-24.05.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/akonadi-calendar-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/akonadi-calendar-24.05.2.tar.xz.sig
...
%setup -q -n akonadi-calendar-24.05.2
cd %{_builddir}/akonadi-calendar-24.05.2
pushd ..
cp -a akonadi-calendar-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720631133
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6AkonadiCalendar.so.6.1.2
...
/usr/lib64/libKPim6AkonadiCalendar.so.6.1.2
